 ...
 *******************************************************************************/
package com.liferay.ide.xml.core.search.contentassist;

import com.liferay.ide.xml.core.LiferayXmlCore;
...
public class ServletContentAssistAdditionalProposalInfoProvider extends
	...
	public Image getImage(Node node) {
		return LiferayXmlCore.getDefault().getImageRegistry().get(
		        LiferayXmlCore.SERVLET_IMG);
	}

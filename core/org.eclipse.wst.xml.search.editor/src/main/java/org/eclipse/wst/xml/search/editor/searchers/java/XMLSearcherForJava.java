...
public class XMLSearcherForJava implements IXMLSearcher {
	...
	public IValidationResult searchForHirerchyValidation(Object selectedNode,
        String mathingString, int startIndex, int endIndex, IFile file,
        IXMLReferenceTo referenceTo) throws JavaModelException {
        ...
        for (IType superType: superTypes) {
            if (JdtUtils.hierarchyContainsComponent(type, superType.getFullyQualifiedName())){
                return IValidationResult.OK;
            }
        }
        return IValidationResult.NOK;
	}

	...
	public static void trace(byte level, String s, Throwable t) {
		...
		if (level == SEVERE) {
			if (!logged.contains(s)) {
				XMLSearchEditorUIPlugin.getDefault().getLog().log(
						new Status(IStatus.ERROR,
								XMLSearchEditorUIPlugin.PLUGIN_ID, s, t));
				logged.add(s);
			}
		}

		if (!XMLSearchEditorUIPlugin.getDefault().isDebugging())
			return;

		StringBuilder sb = new StringBuilder(XMLSearchEditorUIPlugin.PLUGIN_ID);
		sb.append(" ");

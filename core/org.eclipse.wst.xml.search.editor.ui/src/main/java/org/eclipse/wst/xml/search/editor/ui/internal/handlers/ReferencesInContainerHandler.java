 ...
 *******************************************************************************/
package org.eclipse.wst.xml.search.editor.ui.internal.handlers;
...
import org.eclipse.wst.xml.search.editor.core.references.XMLReferencePathResult;
...
import org.eclipse.wst.xml.search.editor.ui.internal.util.ExceptionHandler;
	...
	public Object execute(ExecutionEvent event) throws ExecutionException {
		...
		if (textEditor == null) {
			showOperationUnavailableDialog(
					XMLSearchEditorUIPlugin.getActiveWorkbenchShell(),

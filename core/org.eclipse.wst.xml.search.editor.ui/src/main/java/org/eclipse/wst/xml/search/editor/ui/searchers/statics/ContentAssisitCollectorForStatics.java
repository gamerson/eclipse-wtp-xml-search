 ...
 *******************************************************************************/
package org.eclipse.wst.xml.search.editor.ui.searchers.statics;
...
import org.eclipse.wst.xml.search.editor.ui.searchers.AbstractContentAssisitCollector;
...
public class ContentAssisitCollectorForStatics extends
	...
	private void collect(final IContentAssistProposalRecorder recorder,
		...
		IContentAssistAdditionalProposalInfoProvider provider = ContentAssistsUtil.getProvider(referenceToStatic);
		if (provider != null) {

 ...
 *******************************************************************************/
package org.eclipse.wst.xml.search.editor.ui.searchers.xml;
...
public class ContentAssisitCollectorForXML extends
	...
	private void collect(final IContentAssistProposalRecorder recorder,
		...
		IContentAssistAdditionalProposalInfoProvider provider = ContentAssistsUtil.getProvider(referencePath);
		if (provider != null) {
